...
export const translations: Record<Language, Record<string, string>> = {
  uz: {
    // Welcome & Auth
    welcome: "Assalomu alaykum! Botdan foydalanish uchun elektron pochtangizni kiriting:",
    welcome_back: "Xush kelibsiz {{email}}!",
    email_invalid: "Iltimos, to'g'ri elektron pochta manzilini kiriting.",
    password_prompt: "Endi parolingizni kiriting:",
    auth_failed: "Email yoki parol noto'g'ri. Iltimos, qaytadan urinib ko'ring.",
    email_registered: "Email muvaffaqiyatli ro'yxatdan o'tkazildi! {{email}}",
    ...
    admin_broadcast_prompt: "Barcha foydalanuvchilarga yuboriladigan xabarni yozing:",
    ...
    purchase_item: "{{plan}} - {{price}} so'm\nHolat: {{status}}\nSana: {{date}}",
    
    // Logout
    logout_confirm: "Haqiqatan ham chiqmoqchimisiz?",
    logout_success: "Siz muvaffaqiyatli chiqdingiz. Qayta kirishuchun /start bosing.",
  ...
  ru: {
    // Welcome & Auth
    welcome: "Здравствуйте! Введите свой email для использования бота:",
    welcome_back: "Добро пожаловать {{email}}!",
    ...
    admin_broadcast_prompt: "Напишите сообщение для отправки всем пользователям:",
    ...
    error_not_logged_in: "Пожалуйста, сначала войдите с помощью команды /start.",
  },
  
  en: {
    // Welcome & Auth
    welcome: "Hello! Please enter your email to use the bot:",
    ...
    // Feedback
    feedback_prompt: "Write your feedback. We will connect with admin anonymously:",
    feedback_sent: "Your feedback has been sent successfully! Admin will reply soon.",
    ...
    premium_quarterly: "🎯 Quarterly Plan\n💰 97,570 UZS / 3 months\n\n✅ Everything in Monthly Plan\n✅ Price lock for future updates\n🏆 Best Offer",
    btn_1month: "1 month - 34,540 UZS",
    btn_3month: "3 months - 97,570 UZS",
    
    // Payment
    payment_card: "💳 Payment Information:\n\nCard Number: {{cardNumber}}\nCard Holder: {{cardHolder}}\n\nPlease make the payment and upload the receipt:",
    receipt_prompt: "Send the receipt image or file:",
    payment_submitted: "✅ Your request has been received!\n\nAdmins will connect with you within 24 hours.\n\nThank you for using our service! 🙏",
    premium_request: "💎 New Premium Request\n\nUser: {{email}}\nPlan: {{plan}}\nPrice: {{price}} UZS\n\nUse buttons to approve or reject.",
    premium_approved: "🎉 Congratulations!\n\nYour Premium subscription has been approved. You can now use all premium features!",
    premium_rejected: "❌ Sorry, your premium request has been rejected.\n\nReason: {{reason}}\n\nYou can contact admin for more information.",
    btn_approve: "✅ Approve",
    btn_reject: "❌ Reject",
    ...
    purchase_item: "{{plan}} - {{price}} UZS\nStatus: {{status}}\nDate: {{date}}",
    
    // Logout
    logout_confirm: "Are you sure you want to logout?",
    logout_success: "You have successfully logged out. Press /start to login again.",
