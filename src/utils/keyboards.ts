...
export function createMainMenuKeyboard(
  ...
  return {
    keyboard: [
      ...
      [{ text: t("cmd_language", lang) }, { text: t("cmd_logout", lang) }],
    ],
...
export function createAdminMainMenuKeyboard(): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
      [{ text: "📊 Feedback List" }, { text: "💎 Premium Requests" }],
      [{ text: "📢 Broadcast Message" }, { text: "📈 Statistics" }],
...
export function createPremiumKeyboard(
  lang: Language,
...
export function createAdminPremiumKeyboard(
  requestId: string,
): TelegramBot.InlineKeyboardMarkup {
  return {
    inline_keyboard: [
      ...
      [
        {
          text: "💬 Message User",
          callback_data: `admin_message_${requestId}`,
        },
      ],
    ],
  };
...
export function createAdminFeedbackKeyboard(
  feedbackId: string,
): TelegramBot.InlineKeyboardMarkup {
  return {
    inline_keyboard: [
      [
        {
          text: "💬 Reply",
          callback_data: `admin_reply_feedback_${feedbackId}`,
        },
      ],
    ],
  };
